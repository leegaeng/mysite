...
<link href="/mysite_jstl/assets/css/main.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" src="/mysite_jstl/assets/images/leegaeng.PNG">
					...
					<p>
						...
						입니다.<br> <br> <a href="/mysite_jstl/guestbook">방명록</a>에
						글 남기기<br>
					</p>
				</div>
			</div>
